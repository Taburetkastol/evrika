...
### Реализация
Стэк: Java 17 + Maven + Spring Boot.
Поиск пользователей производился с помощью API JNA. Пользователи берутся из локальной группы Windows. 
.bat файл содержит скрипт для запуска jar файла и запуск главной страницы.
